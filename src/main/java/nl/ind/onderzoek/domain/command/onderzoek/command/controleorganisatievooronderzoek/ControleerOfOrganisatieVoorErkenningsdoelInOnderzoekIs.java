...
@SuperBuilder
@ToString
public class ControleerOfOrganisatieVoorErkenningsdoelInOnderzoekIs extends AbstractOnderzoekCommand {

    private boolean organisatieMetErkenningsdoelIsInOnderzoek;
